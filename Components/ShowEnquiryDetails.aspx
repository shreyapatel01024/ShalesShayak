<%@ Page Title="Enquiry Details | SalesSahayak" Language="C#" MasterPageFile="~/Footer.master" AutoEventWireup="true" CodeBehind="ShowEnquiryDetails.aspx.cs" Inherits="SalesSahayak.Components.ShowEnquiryDetails" %>
...
<asp:Label ID="Label2" runat="server" Text="Enquiry Date: "></asp:Label><asp:Label ID="Eq_Date" runat="server" Text=""></asp:Label>
 ...
 <asp:Label ID="Label14" runat="server" Text="Indentor Name: "></asp:Label><asp:Label ID="Indentor_Name" runat="server" Text=""></asp:Label>
      ...
      <br />
                 <asp:Label ID="Label15" runat="server" Text="Total Enquiry Value: "></asp:Label><asp:Label ID="Total_Value" runat="server" Text=""></asp:Label>
<br />
               <br />
  ...
  <br /><asp:Label ID="Label8" runat="server" Text="FollowUp: "></asp:Label><asp:Label ID="Followup" runat="server" Text=""></asp:Label>
           ...
           <br />
               <div class="ButtonsContainer">
                   <div id="Enquiry_Buttons" runat="server">
...
<asp:Button ID="OrderConvert" runat="server" Text="OrderConvert" type="submit" OnClick="OrderConvert_Click" CssClass="OrderConvert_Btn"  />
