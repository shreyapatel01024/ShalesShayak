<%@ Page Title="Order Details | SalesSahayak" Language="C#" MasterPageFile="~/Footer.master" AutoEventWireup="true" CodeBehind="ShowOrderDetails.aspx.cs" Inherits="SalesSahayak.Components.ShowOrderDetails" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
                <div class="OrderDetailsContent">  
    <h2 class="">Order Details</h2>
           <div class="OrderDetailsContainer">
               <div class="OrderIdContainer">
               <asp:Label ID="Label10" runat="server" Text="Order Id: " CssClass="OrderIdLabel"></asp:Label>  <asp:Label ID="Ord_Id" runat="server" Text="" CssClass="OrderIdText"></asp:Label>
...
<asp:Label ID="Label2" runat="server" Text="Order Date: "></asp:Label><asp:Label ID="Ord_Date" runat="server" Text=""></asp:Label>
 ...
 <asp:Label ID="Label3" runat="server" Text="Customer ID: "></asp:Label><asp:Label ID="Cust_Id" runat="server" Text=""></asp:Label>
        ...
        <asp:Label ID="Label13" runat="server" Text="Customer Name: "></asp:Label><asp:Label ID="Cust_Name" runat="server" Text=""></asp:Label>
               <br />
                <asp:Label ID="Label19" runat="server" Text="Enquiry_Id: "></asp:Label><asp:Label ID="Enquiry_Id" runat="server" Text=""></asp:Label>
               <br />
  ...
  <br /><asp:Label ID="Label8" runat="server" Text="Total Payment Received: "></asp:Label><asp:Label ID="TotalPaymentReceived" runat="server" Text=""></asp:Label>
           ...
           <br />
               <div class="ButtonsContainer">
                 ...
                 <div id="Order_Buttons" runat="server">
<asp:Button ID="Edit" runat="server" Text="Edit" type="submit" CssClass="Edit_Btn" OnClick="Edit_Btn"/>
                   <asp:Button ID="AddPayment" runat="server" Text="Add Payment" type="submit" OnClick="AddPayment_Click"  CssClass="AddPayment_Btn"/>
 
<asp:Button ID="OrderDelivered" runat="server" Text="Order Delivered" type="submit" OnClick="OrderDelivered_Click"  CssClass="OrderDelivered_Btn"/>
