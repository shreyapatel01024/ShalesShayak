...
{
    public partial class ConvertToOrder : System.Web.UI.Page
    {
        ...
        string fetchedQEnquiry_Id;  //!--- To Store Order Id from QueryString
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Session.Count != 0)
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    fetchedQEnquiry_Id = Request.QueryString["Eq_id"];

                    //!--- Breaking Order Id
                    prefix = fetchedQEnquiry_Id.Substring(0, 3);
                    i = Convert.ToInt32(fetchedQEnquiry_Id.Substring(3, 4));
                    j = Convert.ToInt32(fetchedQEnquiry_Id.Substring(7, 2));
        ...
        void fetchOrderDetails()
        {
            ...
            while (loop)
            {
                ...
                fetchedQEnquiry_Id = prefix + id + idinner;
                string query = "SELECT * FROM Enquiry where Enquiry_Id='" + fetchedQEnquiry_Id + "'";
        ...
        void fetchsingledata()
        {
            ...
            conn.Open();
            cmd.Connection = conn;
            System.Diagnostics.Debug.WriteLine("FetchedOrderid" + fetchedQEnquiry_Id);
            cmd.CommandText = "Select * from Enquiry where Enquiry_Id='" + fetchedQEnquiry_Id + "'";
            OleDbDataReader reader = cmd.ExecuteReader();
            if (reader.Read())
            {
        ...
        void UpdateEnquiry()
        {
            ...
            cmd.CommandText = "update Enquiry Set Status='"+"Converted"+"' where Enquiry_Id='" + fetchedQEnquiry_Id + "'";
          cmd.ExecuteNonQuery();
            conn.Close();
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            if (ControlCounter > 1)
            {
                    ...
                    if (ddlProduct != null && tbQuanity != null)
                    {
                        ...
                        if (j == 0)
                        {
                           ...
                           string Orders_id = prefix + OD + id + idinner;  //!--- Merging all the Parts of Orders Id 
                            ...
                            var date = dt.Date;
                            cmd.CommandText = "Insert into Orders Values('" + Orders_id + "','" + date + "','" + PurchaseOrder_Number.Text + "','" + customerid + "','" + Indentor_Name.Text + "','" + Indentor_Email.Text + "','" + selectedValue + "'," + quantity + "," + TotalProductValue + "," + TotalOrdersValue + ",'" + "Received" + "','" + Advance_Payment.Text + "','" + PaymentStatus + "','" + "MAIN" + "'," + Emp_Id + ",'" + fetchedQEnquiry_Id + "'," + Com_Id + ",'" + "FALSE" + "')";
                            cmd.ExecuteNonQuery();
                            conn.Close();
                        ...
                        else
                        {
                            ...
                            quantity = Convert.ToInt32(tbQuanity.Text);
                                ...
                                DateTime dt = DateTime.Now;
                            var date = dt.Date;
                            cmd.CommandText = "Insert into Orders Values('" + Orders_id + "','" + date + "','" + PurchaseOrder_Number.Text + "','" + customerid + "','" + Indentor_Name.Text + "','" + Indentor_Email.Text + "','" + selectedValue + "'," + quantity + "," + TotalProductValue + "," + 0 + ",'" + "Received" + "','" + Advance_Payment.Text + "','" + PaymentStatus + "','" + "PART" + "'," + Emp_Id + ",'" + fetchedQEnquiry_Id + "'," + Com_Id + ",'" + "FALSE" + "')";
                            cmd.ExecuteNonQuery();
                            conn.Close();
                ...
                Success.Text = "Orders Added Successfully to Database";
                UpdateEnquiry();
                Response.Redirect("ShowOrderDetails.aspx?Ord_id=" + MainOrders_id);
                clearall();
            }
            else
            {
        ...
        {
            fetchedQEnquiry_Id = Request.QueryString["Eq_id"];
            Response.Redirect("ShowEnquiryDetails.aspx?Eq_id=" + fetchedQEnquiry_Id);
        }
