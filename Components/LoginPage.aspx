    ...
    <div class="loginbox">
        ...
        <asp:Image ID="Image1" runat="server" ImageUrl="../Images/imp2.png" CssClass="user" />
            ...
            <div class="inputbox">
                ...
                <asp:TextBox runat="server" Class="txtemail" placeholder="Enter ID" ID="idText" OnTextChanged="idText_TextChanged"  ></asp:TextBox><div class="icon"><i class='bx bxs-user'></i></div>
            </div>
            <div class="inputbox">
