...
<asp:Content ID="Content2" runat="server"
    ...
    <div class="box">
       ...
       <div class="input-box">
        <div class="1box">
            <div class="box1">
            <asp:Chart ID="Chart1" runat="server" Width="550px" DataSourceID="AccessDataSource1">
                <Series>
        ...
        <div class="box1">
            <asp:Chart ID="Chart2" runat="server" Width="550px" DataSourceID="AccessDataSource1">
                <Series>
            ...
            <div class="2box">
        <div class="box2">
            <asp:Chart ID="Chart3" runat="server" Width="450px" DataSourceID="AccessDataSource1">
                <Series>
        ...
        <div class="box2">
            <asp:Chart ID="Chart4" runat="server" Width="450px" DataSourceID="AccessDataSource1">
                <Series>
            ...
            <div class="3box">
        <div class="box3">
            <asp:Chart ID="Chart5" runat="server" Width="350px" DataSourceID="AccessDataSource1">
                <Series>
        ...
        <div class="box3">
            <asp:Chart ID="Chart6" runat="server" Width="350px" DataSourceID="AccessDataSource1">
                <Series>
