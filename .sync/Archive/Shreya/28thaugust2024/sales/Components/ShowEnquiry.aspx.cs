    ...
    public partial class ShowEnquiry : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //string EnquiryStatus = DropDownList1.SelectedValue;
        ...
        private void BindDataEmployee(string EnquiryStatus)
        {
            ...
            string query = "SELECT Enquiry.Enquiry_Id,Enquiry.Enquiry_Date,Enquiry.Customer_Id,Customer.Customer_Name,Enquiry.Product_Name, Enquiry.Quantity,Enquiry.Value,Enquiry.Status,Enquiry.Follow_Up FROM Customer,Enquiry where Enquiry.Customer_Id=" +"Customer.Customer_Id"+ " and  Enquiry.Company_Id=" +Company_Id+ " and Enquiry.Enquiry_Type='" + "MAIN" + "' and Enquiry.Emp_Id="+Employee_Id+" and Enquiry.Status='"+EnquiryStatus+"'";
